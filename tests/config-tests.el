...
(ert-deftest config-should-support-idea-journal-and-brainstorm-capture ()
  (let ((content (file-content "config.org")))
    (should (string-match-p "my/orgfiles-idea-file" content))
    (should (string-match-p "ideas\\.org" content))
    (should (string-match-p "my/orgfiles-brainstorm-file" content))
    (should (string-match-p "brainstorm\\.org" content))
    ...
    (should (string-match-p "(\"b\" \"Brainstorm\" entry" content))
