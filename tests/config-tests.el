...
(ert-deftest config-should-enable-space-style-keybindings ()
  (let ((content (file-content "config.org")))
    ...
    (should (string-match-p "\"q -\" #'my/font-size-decrease" content))
    (should (string-match-p "\"q =\" #'my/font-size-increase" content))
    (should (string-match-p "\"q 0\" #'my/font-size-reset" content))))
